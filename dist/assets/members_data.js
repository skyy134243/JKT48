// JKT48 Complete Member Database â€” 69 Members (Gen 3 through Gen 13)
...
window.JKT48_MEMBERS = [
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  //  MEMBER INTI (Gen 3 â€” Gen 11)
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  ...
  },
  {
    ...
    idnUrl: "https://www.idn.app/delynnjkt48"
  },
  {
    id: "lana",
    name: "Aurhel Alana",
...
// Helper: Build a lookup map from showroomSlug â†’ memberId
export const SHOWROOM_SLUG_MAP = new Map(
  JKT48_MEMBERS.map(m => [m.showroomSlug, m.id])
);

// Helper: Build a lookup map from idnSlug â†’ memberId  
